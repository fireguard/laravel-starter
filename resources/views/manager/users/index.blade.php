                ...
                <div class="col-xs-12 ">
                    <div class="table-responsive">
                        <table class="table table-hover table-condensed" >
                            <thead>
                            <tr>
                                <th style="min-width: 40px;"><span class="legend-icon"><i class="fa fa-search "></i></span> Id</th>
                                <th><span class="legend-icon"><i class="fa fa-search "></i></span> Nome</th>
                                <th><span class="legend-icon"><i class="fa fa-search "></i></span> Email</th>
                                <th><span class="legend-icon"><i class="fa fa-search "></i></span> Função</th>
